...
%                   'TwoSpirals'    : 2-spiral data set. It requires "dataset package" from http://www.mathworks.com/matlabcentral/fileexchange/41459-6-functions-for-generating-artificial-datasets/content/datasetsdemo.m
%
...
switch lower(cDataName)
    ...
    case {'s-manifold'}
        ...
        NetsOpts = struct( ...
                ...
                'KeepV',0);
    case {'two spirals'}
        Xo = twospirals(cOpts.NumberOfPoints,400,0,0);
        Labels = Xo(:,3);
        Xo = Xo(:,1:2);        
        % Set default options for constructing the graph
        GraphDiffOpts = struct( ...
...
X = X';
GraphDiffOpts=rmfield(GraphDiffOpts,'XIsTransposed');
NetsOpts=rmfield(NetsOpts,'XIsTransposed');
