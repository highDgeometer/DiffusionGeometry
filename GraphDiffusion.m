...
%      [DontReturnDistInfo]: memory-saving option: DistInfo is not returned in G. Default: 0.
...
if isempty(G.Opts.W),
    ...
    if isempty(DistInfo) || ~isfield(DistInfo,'idxs'),
        ...
        if isfield(DistInfo,'CoverTree'),       lOptsTemp.CoverTree = DistInfo.CoverTree;   end;
